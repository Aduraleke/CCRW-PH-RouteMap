...
export const stops: Stop[] = [
  {
    id: "stop1",
    name: "Akpajo",
    path: ["Akpajo", "YKC Junction", "Slaughter", "Rumuobiakani", "Artillery", "AirForce", "Stadium"],
  },
  {
    id: "stop2",
    name: "Old GRA",
    path: ["Old GRA", "Garrison", "GRA","AirForce", "Stadium"],
  },
  {
    id: "stop3",
    name: "Abuloma",
    path: ["Abuloma", "JDP Roundabout", "Amadi Roundabout", "Mother cat", "Nwaja", "Market JTC", "AirForce", "Stadium"],
  },
  {
    id: "stop4",
    name: "KICC Rumuomasi",
    path: ["KICC Rumuomasi", "Stadium"],
  },
  {
    id: "stop5",
    name: "Woji Junction",
    path: ["Woji Junction", "Okporo Road", "Rumudara junction", "Stadium"],
  },
  {
    id: "stop6",
    name: "Eleme Junction",
    path: ["Eleme Junction", "Yank", "Elimgbu", "Atali", "Eneka", "Igwuruta", "Stadium"],
  },
  {
    id: "stop7",
    name: "Elelewon",
    path: ["Elelewon", "YKC Junction", "Slaughter", "Rumuobiakani", "Artillery", "AirForce", "Stadium"],
  },
    {
    id: "stop8",
    name: "DLine",
    path: ["DLine", "Garrison", "GRA","AirForce", "Stadium"],
  },
    {
    id: "stop9",
    name: "CFC",
    path: ["CFC", "Garrison", "GRA","AirForce", "Stadium"],
  },
   {
    id: "stop10",
    name: "Jetty",
    path: ["Jetty", "JDP Roundabout", "Amadi Roundabout", "Mother cat", "Nwaja", "Market JTC", "AirForce", "Stadium"],
  },
   {
    id: "stop11",
    name: "Okru",
  ...
  },
   {
    id: "stop12",
    name: "Igbo-Etche",
    path: ["Igbo-Etche", "Ring Road Roundabout", "Eneka flyover", "Igwuruta", "Nwaja", "Market JTC", "AirForce", "Stadium"],
  },
   {
    id: "stop13",
    name: "Igbo-Etche Junction",
